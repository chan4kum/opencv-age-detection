...
* Stream ``AD_JOBS`` (work-queue retention) carries job messages; a single durable *pull* consumer
...
from age_detection.errors import DependencyUnavailableError
from age_detection.logging_config import get_logger
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise DependencyUnavailableError(
                f"KV bucket {self._s.nats_kv_bucket!r} does not exist (set AD_NATS_PROVISION=true or create it)"
            ) from exc
